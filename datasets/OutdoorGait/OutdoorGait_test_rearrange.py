...
parser.add_argument('--dataset_path', default='OutdoorGait-video-pkl', type=str, help='Rearrange OutdoorGait datasets to probe.')

opt = parser.parse_args()

WORK_PATH = "."  # "D:\\Development\\Python\\Pycharm\\AI\\09GaitRecognitionSystem\\OpenGait"
os.chdir(WORK_PATH)
