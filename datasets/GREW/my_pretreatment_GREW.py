...
# from datasets.HID.is_people.classification import Classification
...
parser.add_argument('--is_people', default=False, type=bool, help='judge is people')
...
if __name__ == '__main__':
    ...
    # output_path = "CASIA-B-video-clean-pkl"
    input_path = "OUMVLP_rearranged" 
    output_path = "OUMVLP-augment-pkl"
